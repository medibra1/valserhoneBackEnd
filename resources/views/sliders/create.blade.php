...
@section('title') Ajout de slider @endsection
            ...
            <div class="col-xs-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Formulaire d'ajout de slider</strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{route('sliders.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off" role="form">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="description1" class="form-control" >{{old('description1')}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="description2" class="form-control">{{old('description2')}}</textarea>
                                </div>
                            </div>

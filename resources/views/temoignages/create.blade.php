...
@section('title') Ajout de temoignage @endsection
            ...
            <div class="col-xs-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Formulaire d'ajout de temoignage</strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{route('temoignages.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off" role="form">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="texte" rows="5" class="form-control">{{old('texte')}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
                                    <input type="text" name="local" value="{{old('local')}}" class="form-control"  />
                                </div>
                            </div>
